 ...
 */
export function textMatchTitleVariants(text, title) {
 ...
 */
export function addIndent(text, indent) {
 ...
 */
export function refreshPage(entryName) {
 ...
 */
export async function vote(voteIDs, templates, message, useBulleted) {
